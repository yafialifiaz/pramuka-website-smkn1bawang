<?php
session_start(); 
require 'koneksi.php';// Memulai session, pastikan ini ada di awal file

// Cek apakah 'pengguna' ada di session
        ...
        <div class="container-fluid program  py-5">
            <div class="container py-5">
                <div class="mx-auto text-center wow fadeIn" data-wow-delay="0.1s" style="max-width: 700px;">
                    <h4 class="mb-5 display-3 d-inline-block p-2 title-border-radius">Berita Prapadra</h4>
                </div>
                <div class="center-container">
                <ul>
                <?php if (isset($_SESSION['pengguna']) && $_SESSION['pengguna'] == "admin") { ?>
                        <li>
                            <button type="button" onclick="window.location.href='tambahberita.php'" class="btn btn-primary">
                                Tambah Data
                            </button>
                            <button type="button" onclick="window.location.href='indexberita.php'" class="btn btn-primary">
                                Index Berita
                            </button>
                        </li>
                    <?php } else {
                    ...
                    <div class="col-md-6 col-lg-6 col-xl-4 wow fadeIn" data-wow-delay="0.1s">
                        <div class="program-item rounded">
                            <div class="program-img position-relative">
                                ...
                                <img src="img/<?php echo $d['foto'] ?>" class="img-fluid w-100">
                                </div>
                            </div>
                            <div class="program-text bg-white px-4 pb-3">
                                <div class="program-text-inner">
                                    <span class="h4"><?php echo $d['judulberita']; ?></span>
                                    <p class="mt-3 mb-0"><?php echo $d['isiberita']; ?></p>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-lg-6 col-xl-4 wow fadeIn" data-wow-delay="0.5s">
                                        <div class="program-item rounded">
                                            <div class="program-img position-relative">
                                                <div class="overflow-hidden img-border-radius">
                                                    <img src="img/pelantikanpramukagaruda.jpg" class="img-fluid w-100" alt="Pelantikan Pramuka Garuda">
                                                </div>
                                            </div>
                                            <div class="program-text bg-white px-4 pb-3">
                                                <div class="program-text-inner">
                                                    <span class="h4">Pelantikan 5 Pramuka Garuda SMKN 1 Bawang</span>
                                                    <p class="mt-3 mb-0">Geliat Pramuka Garuda terus bergema di Kota Dawet Ayu dengan lahirnya lima (5) Pramuka Penegak Garuda dari SMK Negeri 1 Bawang. Sekolah ini berperan penting dalam gerakan Pramuka Penegak di Banjarnegara, dengan pembina yang juga pengurus Kwartir Cabang. Banyak alumni yang kini menjabat sebagai ketua dan anggota Dewan Kerja Cabang, membuktikan keberhasilan dalam kepemimpinan. Prestasi ini menjadikan SMK Negeri 1 Bawang layak diakui sebagai pusat pengembangan Pramuka yang inspiratif.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6 col-lg-6 col-xl-4 wow fadeIn" data-wow-delay="0.5s">
                                        <div class="program-item rounded">
                                            <div class="program-img position-relative">
                                                <div class="overflow-hidden img-border-radius">
                                                    <img src="img/prestasi.jpg" class="img-fluid w-100" alt="Prestasi Pramuka">
                                                </div>
                                            </div>
                                            <div class="program-text bg-white px-4 pb-3">
                                                <div class="program-text-inner">
                                                    <span class="h4">Prestasi Pramuka </span>
                                                    <p class="mt-3 mb-0">Pramuka Banjarnegara kembali menorehkan prestasi dalam lomba dengan semangat dan dedikasi tinggi. Prestasi ini menjadi bukti bahwa Pramuka Banjarnegara siap bersaing di kancah yang lebih luas dan terus berinovasi dalam kegiatan kepramukaan.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
