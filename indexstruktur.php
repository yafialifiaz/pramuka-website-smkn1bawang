...
<div class="container-fluid py-5 hero-header wow fadeIn" style="background-image: url('img/fotojudul.jpg'); background-size: cover; background-position: center; height: 60vh;" data-wow-delay="0.1s">
	...
	<div class="container">
		...
		?>
		<br>
		<a href="tambahstruktur.php" class="btn btn-info btn-sm">Tambah Struktur</a>
        <a href="struktur.php" class="btn btn-info btn-sm">Struktur Organisasi</a>
		<br>		
		<br>		
		<table class="table table-bordered">
			...
			while($d = mysqli_fetch_array($data)){
				...
				<tr>
					...
					<td class="opsi">
                    <a href="editstruktur.php?id=<?php echo $d['id']; ?>" class="btn btn-primary">Edit</a>
                    <a href="hapusstruktur.php?id=<?php echo $d['id']; ?>" class="btn btn-primary" onclick="return confirm('Yakin akan menghapus data?');">Hapus</a>
                </td>                    
				</tr>
				<?php
			}
